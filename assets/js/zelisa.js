// ZeLISA, a mock rule-based chat assistant. No real backend; keyword-matched canned responses
...
const ZELISA_RULES = [
  ...
  {
    keywords: ["updater", "rollout", "latest version", "latest update", "which facilities", "update status"],
    reply: `The <strong>eLMIS Updater</strong> shows which facilities are running the latest Facility Edition release and tracks rollout/update status nationwide. You can log in at <a href="https://rollout.elmis-fe.com/login" target="_blank" rel="noopener">rollout.elmis-fe.com</a>.`
  },
  {
    keywords: ["pcmt", "product catalog", "product catalogue", "master data", "item codes"],
    reply: `<strong>PCMT (Product Catalog Management Tool)</strong> maintains the master product and commodity catalog, including standard item codes and units of issue, shared across eLMIS Central and Facility Edition. See <a href="tools-guides.html#tools">Tools &amp; Guides</a> for related systems.`
  },
  {
  ...
  {
    keywords: ["r&r flow", "approval", "requisition flow", "zammsa", "who approves", "warehouse"],
    reply: `The R&amp;R approval cycle runs in six stages:
      <ol style="margin:8px 0 0 18px; padding:0;">
        ...
        <li>ZAMMSA, 2nd-level approval; converts R&amp;Rs into orders</li>
        <li>ZAMMSA, receive, inspect, store &amp; prepare dispatch</li>
        <li>Delivery to Hubs, DHO &amp; Hospital</li>
