...
No build step and no backend, just plain HTML/CSS/JS, so it deploys instantly on GitHub Pages and is easy for anyone to fork and edit.

## What's included

| Page | Purpose |
|---|---|
| `index.html` | Landing page, with live stats, Production/Test environment login links, CHW app callout, previews of About/Analytics/News/Tools/ZeLISA |
...
| `news.html` | News & release announcements, filterable by category, including the real September 2025 Transition Ceremony results |
...
| `zelisa.html` | **ZeLISA**, the Zambia eLMIS Logistics Intelligence and Supply Chain Agent chat prototype (rule-based canned responses grounded in real eLMIS facts, no real backend yet) |
